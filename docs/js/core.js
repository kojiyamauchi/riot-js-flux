...
/* WEBPACK VAR INJECTION */(function(riot) {/* Riot v3.7.4, @license MIT */
...
var _riot = __webpack_require__(21);

var _riot2 = _interopRequireDefault(_riot);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var TodoStore = void 0; // Flux Architecture, -Store- Script.


TodoStore = function TodoStore() {
...
var _riotcontrol = __webpack_require__(50);

var _riotcontrol2 = _interopRequireDefault(_riotcontrol);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var TodoAction = void 0; // Flux Architecture, -Action- Script.


TodoAction = {
  initCart: function initCart() {
    _riotcontrol2.default.trigger('init_cart');
  },
  addCart: function addCart(_target) {
    _riotcontrol2.default.trigger('add_cart', _target);
  },
  resetCart: function resetCart() {
    _riotcontrol2.default.trigger('reset_cart');
  }
};
...
var _stores = __webpack_require__(91);
...
_riotcontrol2.default.addStore(new _stores2.default());
...
var riot = __webpack_require__(21);
//src: tags/heading.tag
...
riot.tag2('cart', '<inner each="{list}"> <imgbox><img riot-src="{img}"></imgbox> <pdname>{name}</pdname> <totalprice> <span id="totalPrice">Total Price</span>¥ <span class="{addComma: true}">0</span><span class="{checkPrice: true}">{price}</span></totalprice> <count> <span>Total Number</span>{total}</count> <button onclick="{reset}" disabled="{total==0}">Reset</button> </inner>', 'cart,[data-is="cart"]{ display: inline-block; width: 50%; padding: 0 0 0 10px; text-align: center; color: #999999; transform: translate(25%, 0); opacity: 0; } @media screen and (-webkit-min-device-pixel-ratio: 0) { cart,[data-is="cart"]{ height: 500px; } } @media all and (-webkit-min-device-pixel-ratio: 0) and (min-resolution: 0.001dpcm) { cart,[data-is="cart"]{ height: auto; } } cart.on,[data-is="cart"].on{ transition: all 0.5s ease-out 0.5s; transform: translate(0, 0); opacity: 1; } cart inner,[data-is="cart"] inner{ background-color: #fff; border-left: solid 5px #999999; border-right: solid 5px #999999; box-sizing: border-box; display: block; height: 100%; } @media screen and (-webkit-min-device-pixel-ratio: 0) { cart inner,[data-is="cart"] inner{ padding-bottom: 60px; } } @media all and (-webkit-min-device-pixel-ratio: 0) and (min-resolution: 0.001dpcm) { cart inner,[data-is="cart"] inner{ padding-bottom: 0; } } cart inner imgbox,[data-is="cart"] inner imgbox{ width: 100%; display: block; height: 330px; line-height: 300px; text-align: center; padding: 20px 0; } cart inner imgbox img,[data-is="cart"] inner imgbox img{ height: 100%; vertical-align: top; } cart inner pdname,[data-is="cart"] inner pdname{ display: block; font-size: 28px; margin: 0 0 8px; letter-spacing: 0.03em; font-style: italic; } cart inner totalprice,[data-is="cart"] inner totalprice{ display: block; font-size: 22px; margin: 0 0 8px; } cart inner totalprice span#totalPrice,[data-is="cart"] inner totalprice span#totalPrice{ font-size: 18px; margin: 0 8px 0 0; } cart inner totalprice span.addComma,[data-is="cart"] inner totalprice span.addComma{ font-size: 22px; } cart inner totalprice span.checkPrice,[data-is="cart"] inner totalprice span.checkPrice{ display: inline-block; width: 0; height: 0; opacity: 0; } cart inner count,[data-is="cart"] inner count{ display: block; font-size: 20px; font-weight: bold; margin: 0 0 8px; } cart inner count span,[data-is="cart"] inner count span{ font-size: 16px; margin: 0 8px 0 0; font-weight: normal; } cart inner button,[data-is="cart"] inner button{ cursor: pointer; border: none; border-radius: 6px; width: 300px; height: 36px; color: #fff; background-color: #999999; font-size: 18px; padding: 0; margin: 10px 0 0; transform: scale(1); transition: transform 0.25s; } cart inner button:focus,[data-is="cart"] inner button:focus{ outline: none; } cart inner button:active,[data-is="cart"] inner button:active{ transform: scale(0.95); transition: transform 0.25s; } cart inner button:disabled,[data-is="cart"] inner button:disabled{ cursor: default; opacity: 1; background-color: #fff; border: solid 2px #999999; color: #999999; position: relative; transform: scale(0.9); transition: transform 0.5s; } cart inner button:disabled:after,[data-is="cart"] inner button:disabled:after{ display: inline-block; content: " "; width: 100px; border-bottom: solid 2px #999999; position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%); opacity: 0.6; }', 'class="{displayed: true}" ref="flux_cart"', function (opts) {
  var cart = this;

  cart.list = [];

  _riotcontrol2.default.on('changes_cart', function (list) {
    cart.list = list;
    cart.update();
  });
